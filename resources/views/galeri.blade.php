...
<html lang="id">
    <head>
        ...
        <title>Galeri Kegiatan - AantassenaSwimClub</title>
        <meta name="description" content="Lihat momen-momen seru latihan renang dan kegiatan AantassenaSwimClub. Galeri foto kegiatan atlet renang muda.">
        <meta property="og:title" content="Galeri Kegiatan - AantassenaSwimClub">
        <meta property="og:description" content="Lihat momen-momen seru latihan renang dan kegiatan AantassenaSwimClub. Galeri foto kegiatan atlet renang muda.">
        <meta property="og:type" content="website">
        <meta property="og:image" content="{{ asset('images/Logo_ASR.png') }}">
        <meta property="og:url" content="{{ url('/galeri') }}">
        <link rel="canonical" href="{{ url('/galeri') }}">
