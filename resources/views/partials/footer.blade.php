        ...
        <div class="space-y-4">
            ...
            <ul class="space-y-4">
                ...
                <li class="flex items-center gap-3 text-on-surface-variant">
                    ...
                    <a class="transition-colors hover:text-primary" href="mailto:gilangaudiokorgiepangestu@gmail.com">gilangaudiokorgiepangestu@gmail.com</a>
                </li>
                <li class="flex items-center gap-3 text-on-surface-variant">
                    ...
                    <a class="transition-colors hover:text-primary" href="https://www.instagram.com/asc_lampung/" target="_blank" rel="noopener noreferrer">@asc_lampung</a>
                </li>
            </ul>
        </div>
        <!-- Map Placeholder -->
