...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex items-center justify-center min-h-screen p-0 antialiased bg-background text-on-surface font-body md:p-gutter">
        <main class="w-full h-screen md:h-[calc(100vh-48px)] md:max-h-[900px] max-w-container_max_width mx-auto bg-surface-container-lowest md:rounded-2xl overflow-hidden shadow-[0px_12px_32px_rgba(23,32,51,0.12)] flex flex-col md:flex-row">
            ...
            <section class="relative flex-col justify-between hidden w-1/2 h-full p-12 overflow-hidden md:flex bg-primary">
                <!-- Background Image -->
                ...
                <div class="relative z-20 flex flex-col justify-between h-full">
                    ...
                    <!-- Slogan Area -->
                    <div class="max-w-md">
                        <h2 class="mb-4 leading-tight font-headline text-headline-xl text-on-primary">Berenang Lebih Percaya Diri. <br/>Tumbuh Lebih Hebat.</h2>
