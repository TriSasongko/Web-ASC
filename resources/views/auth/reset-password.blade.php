<x-guest-layout>
    <div class="mb-6">
        <h2 class="font-headline text-headline-md text-on-surface">Reset Password</h2>
        <p class="font-body-sm text-body-sm text-outline mt-1">Buat password baru untuk akun Anda.</p>
    </div>
