<x-sidebar-layout>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="{{ route('pelatih.attendances.create') }}" class="group bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0px_4px_20px_rgba(23,32,51,0.02)] p-6 transition-all hover:border-primary/40 hover:shadow-lg">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-headline text-headline-sm text-on-surface">Ambil Absensi</h3>
                        <p class="font-body-sm text-body-sm text-outline mt-1">Pilih tanggal, cari nama murid, lalu centang siswa yang hadir. Bisa untuk kelas mana pun.</p>
                    </div>
                </div>
            </a>

            <a href="{{ route('pelatih.attendances.history') }}" class="group bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0px_4px_20px_rgba(23,32,51,0.02)] p-6 transition-all hover:border-primary/40 hover:shadow-lg">
                <div class="flex items-start gap-4">
        ...
        <div class="bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0px_4px_20px_rgba(23,32,51,0.02)] p-6 md:p-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="font-body-sm text-body-sm text-outline mt-1">Total kehadiran siswa yang pernah Anda catat. Data ini juga menjadi dasar perhitungan gaji coach.</p>
                </div>
            </div>
        </div>
    </div>
