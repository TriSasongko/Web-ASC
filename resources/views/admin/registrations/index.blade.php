<x-sidebar-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Pendaftaran Siswa</h2>
    </x-slot>
                    ...
                    <tbody>
                        @forelse ($registrations as $reg)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">{{ $reg->student->parent->name }}</td>
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('admin.registrations.show', $reg) }}" class="text-indigo-600">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr><td colspan="5" class="px-4 py-6 text-center text-gray-500">Belum ada pendaftaran masuk.</td></tr>
                        @endforelse
                    </tbody>
                </table>
