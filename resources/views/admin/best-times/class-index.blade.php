<x-sidebar-layout>
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h2 class="font-headline text-headline-lg-mobile md:text-headline-lg text-on-surface">Best Time Siswa — {{ $class->name }}</h2>
                <p class="font-body-sm text-body-sm text-outline mt-1">Catat rekor pribadi waktu renang untuk setiap siswa di kelas Kompetitif ini.</p>
            </div>
        </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0px_4px_20px_rgba(23,32,51,0.02)] overflow-hidden">
            <div class="p-5 border-b border-outline-variant/30 bg-surface/50 flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full font-label-sm text-label-sm bg-primary/10 text-primary">
                            ...
                            <tr class="hover:bg-surface-container-low/50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-4">
                                        <a href="{{ route('admin.classes.best-times.create', [$class, $student]) }}" class="inline-flex items-center gap-1 text-primary font-label-md text-label-md hover:underline">
                                            <span class="material-symbols-outlined text-[16px]">edit_note</span>
                                            Isi Catatan
                                        </a>
                                        <a href="{{ route('admin.classes.best-times.history', [$class, $student]) }}" class="inline-flex items-center gap-1 text-primary font-label-md text-label-md hover:underline">
